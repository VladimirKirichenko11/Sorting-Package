...
class TestBubbleSort(unittest.TestCase):
    ...
    def test_negative_numbers(self):
        self.assertEqual(bubble_sort([-3, -1, -4, -2]), [-4, -3, -2, -1])

    def test_mixed_numbers(self):
        self.assertEqual(bubble_sort([3, -1, 0, -2, 5]), [-2, -1, 0, 3, 5])

    def test_reverse_sort(self):
        self.assertEqual(bubble_sort([3, 1, 4, 1, 5], reverse=True), [5, 4, 3, 1, 1])
